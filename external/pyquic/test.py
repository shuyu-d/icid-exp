...
# Run in "default" mode
X, W, opt, cputime, iters, dGap = quic(S=newS, L=0.5,\
        max_iter=100, msg=2)
test = 923.1042
...
XP, WP, optP, cputimeP, iterP, dGapP = quic(S=newS, L=1.0,
...
# Run in trace mode
print("")
XT, WT, optT, cputimeT, iterT, dGapT = quic(S=newS, L=0.5, \
